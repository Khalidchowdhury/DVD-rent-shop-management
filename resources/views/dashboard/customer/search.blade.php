                ...
                <div class="container">
                    ...
                    <form action="{{ route('CustomerSearch.page') }}" method="GET" role="search">
                        <div class="input-group mb-3">
                            <input type="search" name="search" class="form-control" placeholder="Search Customer..." aria-label="Search customer" aria-describedby="button-addon2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                               ...
                               @forelse ( $searchCustomer as $custommer )
                                <tr>
                               ...
                               @empty
                               <tr>
                                 <td colspan="4" style="text-align: center;">No Customer are found.</td>
                               </tr>
                               @endforelse

                            </tbody>
                        </table>
                        <a href="{{ route('customer.page') }}" class="btn btn-primary">Back</a>
                    </div>
                </div>
            </div>
        </div>
