                ...
                <div class="container">
                    ...
                    <form action="{{ route('search.page') }}" method="GET" role="search">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Search Movie..." aria-label="Search for movies" aria-describedby="button-addon2">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @forelse ($searchProducts as $movie)
                                    <tr>
                                        <td>{{ $loop->index +1 }}</td>
                        ...
                        <a href="{{ route('movie.page') }}" class="btn btn-primary">Back</a>
